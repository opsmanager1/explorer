...
export default {
  ...
  data() {
    return {
      erc20: '0x4f4Dec70d31713cebB7D42297717a0CA25d3d5fC',
      selectedAddress: 'cosmos1m2mm7kzvw6m3464h94ryqg8xvr6tyeyyecppnq',
    }
  },
  computed: {
    chains() {
      const { data } = addressDecode('cosmos1m2mm7kzvw6m3464h94ryqg8xvr6tyeyyecppnq')
